...
Probability of clearing a hurdle $ \pr{E}  =  \frac{5}{6} $

Probability of knocking down a hurdle $\pr{{E}^\prime} = 1 - \frac{5}{6} = \frac{1}{6} $
...
Using Cummulative Distribution Function(cdf),
  \begin{align}  F_X\brak{r} = \pr{X \le r} \end{align}
  Here, $r=1$
\begin{align} F_X\brak{1}=\pr{X \le 1} = \pr{X = 0} + \pr{X = 1} \end{align}

Using the binomial distribution formula, 
\begin{align} \pr{X = k} = \comb{n}{k}  p^{k}  (1-p)^{n-k} \end{align}
where,
