...
\hhline{|-------|}
	...
	\gnumericColG+%
	\tabcolsep*2*3}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{Player clears all the hurdles}}
\\
\hhline{|-------|}
	 \multicolumn{2}{|p{	\gnumericColA+%
	\gnumericColB+%
	...
	\gnumericColG+%
	\tabcolsep*2*3}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{Player knocks down one hurdle}}
\\
\hhline{|--|-|----|}
\end{longtable}
