...
\hhline{|------|}
	...
	&\gnumericPB{\raggedright}\gnumbox[l]{Number of hurdles player clears}
	&
	&
	&\multicolumn{1}{p{\gnumericColF}|}%
	{}
...
\hhline{|------|}
	...
	&\gnumericPB{\raggedright}\gnumbox[l]{Total number of hurdles to be crossed}
	&
	&
	&\multicolumn{1}{p{\gnumericColF}|}%
	{}
...
\hhline{|------|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedleft}\gnumbox[r]{0.16667}}
	&\gnumericPB{\raggedright}\gnumbox[l]{Probability to knock down a hurdle}
	&
	&
	&\multicolumn{1}{p{\gnumericColF}|}%
	{}
